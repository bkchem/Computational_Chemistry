#PROGRAM: Cartesian by Bonnie I. Kruft 
#Program extracts Cartesian Coordinates from Gaussian output file
  
# Loads the sys module                         
# Loads the regular expressions module (search function)
